                ...
                {resources.map((source: any) =>
                    (
                        <div className="flex space-x-2" key={source.detail}>
                            <Link className="button-icon" href={source.link}  target="_blank">
                                <Image src={`/icon/${source.icon}.svg`} alt={source.detail} height={44} width={44} />
                            </Link>
                            <Link className="detail-source" href={source.link}  target="_blank">
