  ...
  return (
    <section id="main" className="container">
      <div className="hero-section space-y-8">
        <TitlePage title="Frontend" linkBack="/" backTo="Home" />
        <CardDesc desc="Frontend adalah bagian yang berinteraksi dengan pengguna. Dalam hal ini semua yang tampil di browser adalah tugas serorang frontend developer untuk mengatur tampilan dan interaksinya dengan pengguna. Selain itu, frontend dev bertugas untuk memanfaatkan API yang dibuat oleh backend agar bisa dimanfaatkan pada browser untuk mebuat website lebih interaktif dan dinamis." />
