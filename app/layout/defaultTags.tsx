export default function DefaultTags() {
    return (
        <>
            ...
            <meta property="og:image" content="https://roadmapid.vercel.app/roadmap-logo.svg" />
            <meta property="og:description" content="Mulai perjalananmu sebagai seorang programer di sini!" />
