    ...
    return (
        <section id="main" className="container">
            <div className="hero-section space-y-8">
                ...
                />
                <CardNote 
                    desc="Javascript menjadi salah satu pilihan terbaik untuk mempelajari backend di sisi pengembangan website. Hal ini dikarenakan javascript juga digunakan pada sisi frontend, sehingga para pemula yang ingin mengembangkan website bisa lebih dimudahkan dengan hanya mempelajari satu bahasa pemrograman." 
                />
